...
import { Database, Users, BarChart3, PenSquare } from "lucide-react";
...
const TABS = [
  ...
  { key: "linkedin", label: "LinkedIn", icon: PenSquare },
  ...
  return (
    <div className="min-h-screen bg-[#09090b]">
          ...
          <div className="flex gap-1 overflow-x-auto scrollbar-none">
            {TABS.map((tab) => (
              <button
                ...
                className={cn(
                  "flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-mono transition-all duration-150 shrink-0",
                  activeTab === tab.key
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6">
        ...
        {activeTab === "blog" && <BlogPanel apiKey={apiKey} />}
        {activeTab === "linkedin" && <LinkedInPanel apiKey={apiKey} />}
