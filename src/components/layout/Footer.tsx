    ...
    <footer className="mt-20 py-12">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <p className="font-mono text-sm gradient-text font-bold">{PORTFOLIO.name}</p>
            <p className="text-sm text-[#52525b] mt-1">{PORTFOLIO.title}</p>
          </div>
          ...
          <div className="flex items-center gap-5">
            <a
              ...
              className="text-[#3f3f46] hover:text-[#f4f4f5] transition-colors"
              aria-label="GitHub"
            >
              <GithubIcon size={18} />
            </a>
